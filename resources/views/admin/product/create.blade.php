                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('product#create')}}" enctype="multipart/form-data" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="cc-pament" name="pizzaDescription" type="text" value="{{ old('pizzaDescription')}}" class="form-control @error('pizzaDescription') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Your Description"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pizzaWaitingTime" value="{{old('pizzaWaitingTime')}}" id="" class="form-control @error('pizzaWaitingTime') is-invalid @enderror" placeholder="Enter Waiting Time">
