    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                {{-- <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">PAZ SHOP</span>
                </a> --}}
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ms-auto py-0 d-none d-lg-block">
                            ...
                            <a href="" class="btn px-0 ms-2 me-2">
                                <i class="fas fa-shopping-cart text-warning me-1"></i>
                                <span class="badge text-white border border-white rounded-circle" style="padding-bottom: 2px;">0</span>
                            </a>

                            {{-- <a href="" class="btn px-0 ms-3 text-white me-2">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li><span class="dropdown-item">
                                        <form action="{{route('logout')}}" method="post" class="d-inline">
                                            @csrf
                                            <button class="btn bg-warning text-dark w-100"><i class="fa-solid fa-right-from-bracket me-1"></i>Logout</button>
                                        </form>
                                      </span>
                                  </li>
                                </ul>
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    ...
                    by
                    <a class="text-primary" href="">Phyo Aung Zay</a>
                </p>
            </div>
